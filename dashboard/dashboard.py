...
def input_data():
    try:
        #Input Data Day
        data_day = pd.read_csv("e:/ITS/Coding Camp/Belajar/8. Modul Belajar Analisis Data dengan Python/Proyek Akhir/data/day.csv")
        data_day["dteday"] = pd.to_datetime(data_day["dteday"])

        #Input Data Hour
        data_hour = pd.read_csv("e:/ITS/Coding Camp/Belajar/8. Modul Belajar Analisis Data dengan Python/Proyek Akhir/data/hour.csv")
